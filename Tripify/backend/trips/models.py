...
class TravelPlan(models.Model):
    ...
    budget = models.IntegerField(help_text="예산 (총 예산)")
    people_count = models.IntegerField(default=1, help_text="인원 수")
    start_date = models.DateField(help_text="여행 시작일")
    end_date = models.DateField(help_text="여행 종료일")
    departure_location = models.CharField(max_length=100, help_text="출발지", default='서울특별시')
    ...
    is_recommended = models.BooleanField(default=False, help_text="추천 여부")
    review = models.TextField(blank=True, help_text="후기")
    rating = models.IntegerField(null=True, blank=True, help_text="평점 (1-5)")
    recommended_at = models.DateTimeField(null=True, blank=True, help_text="추천 일시")
