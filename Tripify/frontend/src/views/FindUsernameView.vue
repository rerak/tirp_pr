...
.search-badge svg { width: 18px; height: 18px; }
...
.description { 
  text-align: center; color: #64748b; font-size: 0.95rem; margin: 0; line-height: 1.6; word-break: keep-all; 
}
